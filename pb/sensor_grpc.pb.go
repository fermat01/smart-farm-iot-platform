...
const (
	SensorService_StreamSensorData_FullMethodName = "/smartfarm.SensorService/StreamSensorData"
)
...
type SensorServiceClient interface {
	StreamSensorData(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[SensorReading, Ack], error)
}
...
func (c *sensorServiceClient) StreamSensorData(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[SensorReading, Ack], error) {
...
type SensorService_StreamSensorDataClient = grpc.ClientStreamingClient[SensorReading, Ack]
...
type SensorServiceServer interface {
	StreamSensorData(grpc.ClientStreamingServer[SensorReading, Ack]) error
...
func (UnimplementedSensorServiceServer) StreamSensorData(grpc.ClientStreamingServer[SensorReading, Ack]) error {
...
func _SensorService_StreamSensorData_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(SensorServiceServer).StreamSensorData(&grpc.GenericServerStream[SensorReading, Ack]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type SensorService_StreamSensorDataServer = grpc.ClientStreamingServer[SensorReading, Ack]
...
var SensorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartfarm.SensorService",
