...
const (
	ActuatorService_SetPump_FullMethodName = "/smartfarm.ActuatorService/SetPump"
)
...
type ActuatorServiceClient interface {
	SetPump(ctx context.Context, in *PumpCommand, opts ...grpc.CallOption) (*Ack, error)
}
...
func (c *actuatorServiceClient) SetPump(ctx context.Context, in *PumpCommand, opts ...grpc.CallOption) (*Ack, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ack)
	err := c.cc.Invoke(ctx, ActuatorService_SetPump_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ActuatorServiceServer interface {
	SetPump(context.Context, *PumpCommand) (*Ack, error)
...
func (UnimplementedActuatorServiceServer) SetPump(context.Context, *PumpCommand) (*Ack, error) {
...
func _ActuatorService_SetPump_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PumpCommand)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ActuatorServiceServer).SetPump(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ActuatorService_SetPump_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ActuatorServiceServer).SetPump(ctx, req.(*PumpCommand))
	}
...
var ActuatorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smartfarm.ActuatorService",
	HandlerType: (*ActuatorServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SetPump",
			Handler:    _ActuatorService_SetPump_Handler,
		},
	},
